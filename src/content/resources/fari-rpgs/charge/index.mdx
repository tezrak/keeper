...
To get started as quickly as possible with Charge, checkout it's condensed version: **Dash**, available for free on [itch.io](https://fari-rpgs.itch.io/dash) and on [Keeper](https://keeper.farirpgs.com/resources/fari-rpgs/dash/).
...
For more details on how to design games using Charge, checkout the Charge SRD also available on [itch.io](https://fari-rpgs.itch.io/charge-srd), and on [Keeper](https://keeper.farirpgs.com/resources/fari-rpgs/charge-srd/).
...
If you contribute to this project in any way, your name will be added in the [credits](https://keeper.farirpgs.com/resources/fari-rpgs/charge/credits-2/) of the game. If you designed a specific extra for the game, your name will also be credited there.
...
- Copies of the [Charge RPG Character Sheet](https://fari-rpgs.itch.io/)
