...
**_Loner_** è un gioco di ruolo solitario minimalista pensato per essere giocato con un solo personaggio (il Protagonista). Lo guiderai attraverso la storia che si dipanerà nel corso del gioco, ponendo domande chiuse a un Oracolo che ti aiuterà a ribaltare le tue aspettative. Di tanto in tanto sarai sorpreso con un colpo di scena inaspettato!

_Loner_ segue i seguenti principi di progettazione:
...
Per giocare a _Loner_ avrai bisogno di:
...
- **Quaderno**: _Loner_ non è un gioco solitario diaristico, puoi facilmente giocarlo nel "teatro della mente". Ma se ne senti la necessità puoi ovviamente tenere appunti durante la tua sessione!
...
In _Loner_ anche i Personaggi Non Giocanti (PNG), i Nemici, le Organizzazioni, i Mostri e persino gli oggetti rilevanti come i veicoli sono personaggi!
...
|  D6   | Chi?<br/>Il committente  | Cosa?<br/>La missione | Perché?<br/>Il incentivo | Dove?<br/>La destinazione | Come?<br/>Il seme  | Ostacolo?<br/>La complicazione |
| :---: | :----------------------: | :-------------------: | :----------------------: | :-----------------------: | :----------------: | :----------------------------: |
...
Una partita a _Loner_ è una successione di scene.
...
> Il datapad viene hackerato _e..._ le informazioni contenute non riguardano solo delle attività illecite della Leton Corporation... C'è di più!
...
Un _conflitto_ è una qualsiasi situazione in cui degli avversari si scontrano, attaccandosi, difendendosi o logorandosi a vicenda per vincere.
...
- L'impostazione generale del Generatore di Avventure è ispirata da _The Instant Game_ di Animalball Partners (2007). Nessuno dei suoi contenuti è utilizzato qui.
